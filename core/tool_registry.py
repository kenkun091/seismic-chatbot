...
REGISTRY = [
    ...
    ToolSpec(
        ...
        params={
            ...
            "display": {"type": "string",
                        "description": "How the auto-generated plot renders the section: 'image' (default), 'wiggle', 'both', 'overlay' (wiggle traces drawn on the outcrop photo, depth-registered), or 'overlay_image' (translucent color section on the photo)."},
        },
        required=[],
        defaults={"model": None, "wavelet_freq": 30.0, "wv_type": "ricker", "ormsby_freq": None,
                  "phase_rot": 0.0, "angle": 0.0, "method": "shuey", "dt": 1.0,
                  "pad_time": 50.0, "domain": "time", "display": "image"},
